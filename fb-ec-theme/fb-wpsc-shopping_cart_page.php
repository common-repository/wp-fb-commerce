...
if(wpsc_cart_item_count() < 1) :
   _e('Oops, there is nothing in your cart.', 'wpsc') . "<a href=".get_option("product_list_url")."?fb=commerce>" . __('Keep Shopping', 'wpsc') . (($_SESSION["fbx"]) ? ' | <a href="'.$_SESSION["fbx"].'">Facebook Featured Products</a>' : '') . "</a>";
   return;
endif;
?>
