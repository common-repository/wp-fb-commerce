...
<?php
		...
		while ( wpsc_have_products() ) : wpsc_the_product(); ?>
				...
				<fb:like href="<?php echo wpsc_the_product_permalink(); ?>" send="true" width="450" show_faces="true" font=""></fb:like>
					...
					<div class="productcol">			
						...
						<div class="custom_meta">
							...
							if(wpsc_custom_meta_name() != 'dsq_thread_id') {
							?>
						 ...
						 */
						?>
						<!-- class="product_form" < ?php echo get_option('shopping_cart_url'); ? > -->
						<form enctype="multipart/form-data" class="product_form" action="<?php echo wpsc_the_product_permalink(); ?>" method="post" name="1" id="product_<?php echo wpsc_the_product_id(); ?>">
...
?>						
					...
					<form onsubmit="submitform(this);return false;" action="<?php echo get_option('shopping_cart_url'); //wpsc_this_page_url(); ?>" method="post" name="product_<?php echo wpsc_the_product_id(); ?>" id="product_extra_<?php echo wpsc_the_product_id(); ?>">
